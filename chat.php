                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-hover progress-table text-center">
                                            ...
                                            <tbody>
                                            <?php 
                                                $query = "SELECT * FROM  user WHERE FacultyID = $fac AND UserRole='coordinator'";
                                                ...
                                                if($result->rowCount() > 0){
                                                    while($row = $result->fetch()){                                                            
                                                                ...
                                                                echo "<td><button type='button' class='btn btn-info btn-xs start_chat' data-touserid=".$row['UserId']." data-tousername=".$row['UserName'].">Start Chat</button></td>";  
                                                                // echo "<td><a href='delete-comment.php?commentid=".$row['FacultyName']."'>Delete</a> </td>";                                                                                                              
