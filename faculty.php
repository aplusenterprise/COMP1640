        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
              ...
              <!-- Main -->
                         ...
                         <div class="card">
                            <div class="card-body">
                                <h4 class="header-title" style="font-size: 20px;text-transform: uppercase;">
                                Manage Faculty
                                </h4>
                                                    ...
                                                    while($row = $result->fetch()){    
                                                        $article[] = array(               
                                                            ...
                                                            "fname" => $row["FacultyName"]
                                                                ...
                                                                <a href='delete.php?type=faculty&id=".urlsafe_b64encode($row['FacultyID'])."'><i class='ti-trash'></i></a></td>"; 
                ...
                <!-- CHOOSE ONE TO USE -->
                         <div class="card">
                            ...
                            <h4 class="header-title">Add New Faculty</h4>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <button type="submit" name="faculty" class="btn btn-success btn-md mb-3">Add</button>
                                    </div>
